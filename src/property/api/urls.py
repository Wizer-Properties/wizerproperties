...
urlpatterns = [
    ...
    path("details/<int:pk>/information/", PropertyViewSet.as_view({"get": "property_info"}), name="property_info"),
    ...
    path("analytics/user-properties-locations/", PropertiesAnalyticsView.as_view({"get": "user_properties_locations"}), name="user_properties_locations"),
    path("analytics/user-gender-ratio/", PropertiesAnalyticsView.as_view({"get": "user_gender_ratio"}), name="user_gender_ratio"),
